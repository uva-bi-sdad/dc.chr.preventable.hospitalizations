...
dataset:
  citation:
      title: "Social Data Commons: Health, Behavior, Diet: Preventable Hospitalizations"
      subtitle: ""
      dsDescriptionValue: "Preventable Hospitalizations collected from County Health Rankings"
...
if (file.exists(here::here("data/dataset_doi"))) {
  ...
  if (is.na(dataset_doi)) {
    ...
    save(dataset_doi, file = here::here("R/sysdata.rda")) # run this 
